...
const CartPage = () => {
  ...
  return (
    <>
      <section className="">
        {cart?.length > 0 ? (
          <div className="container mx-auto max-w-[1200px] w-full grid lg:grid-cols-2  gap-10">
              ...
              {cart.map((el) => (
                ...
                >
                  <div className="flex items-center gap-5">
                    ...
                    <div>
                      <h1 className="text-[16px] max-[600px]:text-[12px] font-medium leading-5 line-clamp-2">
                        {el.title}
                      </h1>
                      <p className="sm:text-[18px] max-[600px]:text-[14px] font-bold mt-3">
                        ${el.price}
                      </p>
                    </div>
                  </div>
          ...
          <div>
            ...
            <p className="text-[24px] max-[900px]:text-[20px] max-[600px]:text-[16px] font-extralight text-center mt-3">
              Bosh sahifaga o'ting <br /> Kerakli mahsulotlarni qidiruv orqali <br />
