...
const SinglePage = () => {
  ...
  return (
    <>
      <section>
        <div className="container mx-auto max-w-[1200px] w-full  grid lg:grid-cols-2 gap-10 px-5">
          <img
 ...
 <p className="text-[24px] max-[600px]:text-[14px] text-red-500 w-25 h-10 max-[600px]:w-[60px] max-[600px]:h-[25px] bg-[#FF33331A] rounded-2xl flex items-center justify-center font-bold mt-4">
            ...
            {cart?.find((el) => el.id === singleProduct?.id) ? (
              <div className="grid grid-cols-3  mt-4">
                <button
                  ...
                  className="flex-1 min-w-[20px] rounded-[30px] bg-[#F0F0F0] font-bold text-[24px] cursor-pointer"
                >
                  -
                </button>
                <button className="flex-1 min-w-[20px]  rounded-[30px] bg-[#F0F0F0] font-bold text-[24px] cursor-pointer">
              ...
              <button
                ...
                className="w-full max-[500px]:w-[50%] max-[600px]:mx-auto h-[60px] max-[600px]:h-[40px] rounded-[62px] text-white bg-black font-bold text-[24px] max-[600px]:text-[18px] mt-4"
              >
                Add to Cart
              </button>
            )}
      ...
      <section>
        <div className="container mx-auto max-w-[1200px] w-full py-[30px] px-5 max-[600px]:py-5">
