  ...
  return (
    <>
      <section className="relative bg-[#F2F0F1]">
        <div className="container mx-auto max-w-[1200px] pt-[90px] px-5 flex items-center justify-between max-[900px]:flex-col max-[900px]:pt-20 pb-20 gap-10">
          ...
          <div className="flex-1 flex justify-center max-[900px]:mt-10">
            <img
              className="w-[600px] max-[1024px]:w-[600px] max-[68px]:w-[400px] max-[500px]:w-[300px] h-auto object-cover rounded-[20px]"
              src="/hero.jpg"
              alt="Hero Image"
            />
          </div>
      ...
      <section className="bg-black">
        <div className="container mx-auto w-full max-w-[1200px] px-5">
      ...
      <section>
        <div className="container mx-auto px-5 max-w-[1200px] w-full py-10">
          <div>
      ...
      <section>
        <div className="container mx-auto px-5 max-w-[1200px] w-full bg-[#F0F0F0] rounded-2xl pb-20 my-[90px] ">
